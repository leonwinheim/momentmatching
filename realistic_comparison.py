...
model.compare_sample_moments_forward(x) #Perform all forward passes so the moments are stored, KBNN has to be done seperately
...
model.forward_moments(x)  # Perform forward pass to compute moments
