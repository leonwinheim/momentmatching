...
m6 = r'15 c^6 w[0] + 1/(2 Sqrt[\\[Pi]]) E^(-((mu[0]^2 + mu[1]^2)/(2 c^2))) (-Sqrt[2] (-1 + a^6) c E^(mu[0]^2/(2 c^2)) mu[1] (33 c^4 + 14 c^2 mu[1]^2 + mu[1]^4) w[1] + E^(mu[1]^2/(2 c^2)) (-Sqrt[2] (-1 + a^6) c mu[0] (33 c^4 + 14 c^2 mu[0]^2 + mu[0]^4) w[0] + E^(mu[0]^2/(2 c^2)) Sqrt[\\[Pi]] (2 mu[0]^2 (45 c^4 + 15 c^2 mu[0]^2 + mu[0]^4) w[0] + (-1 + a^6) Erfc[mu[0]/(Sqrt[2] c)] (15 c^6 + 45 c^4 mu[0]^2 + 15 c^2 mu[0]^4 + mu[0]^6) w[0] + (2 + (-1 + a^6) Erfc[mu[1]/(Sqrt[2] c)]) (15 c^6 + 45 c^4 mu[1]^2 + 15 c^2 mu[1]^4 + mu[1]^6) w[1])))'
m7 = r"1/2 Erf[mu[0]/(Sqrt[2] c)] mu[0] (105 c^6 + 105 c^4 mu[0]^2 + 21 c^2 mu[0]^4 + mu[0]^6) w[0] + 1/(2 Sqrt[\\[Pi]]) E^(-((mu[0]^2 + mu[1]^2)/(2 c^2))) (-Sqrt[2] (-1 + a^7) c E^(mu[1]^2/(2 c^2)) (48 c^6 + 87 c^4 mu[0]^2 + 20 c^2 mu[0]^4 + mu[0]^6) w[0] + E^(mu[0]^2/(2 c^2)) (-Sqrt[2] (-1 + a^7) c (48 c^6 + 87 c^4 mu[1]^2 + 20 c^2 mu[1]^4 + mu[1]^6) w[1] + E^(mu[1]^2/(2 c^2)) Sqrt[\\[Pi]] ((1 + a^7 Erfc[mu[0]/(Sqrt[2] c)]) mu[0] (105 c^6 + 105 c^4 mu[0]^2 + 21 c^2 mu[0]^4 + mu[0]^6) w[0] + (2 + (-1 + a^7) Erfc[mu[1]/(Sqrt[2] c)]) mu[1] (105 c^6 + 105 c^4 mu[1]^2 + 21 c^2 mu[1]^4 + mu[1]^6) w[1])))"
